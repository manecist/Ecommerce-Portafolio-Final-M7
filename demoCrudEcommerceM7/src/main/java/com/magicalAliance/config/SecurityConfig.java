    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/recuperar-contrasena", "/nueva-contrasena").permitAll()
                        ...
                        // --- DESCUENTOS Y CUPONES ADMIN ---
                        .requestMatchers("/admin/descuentos/**").hasRole("ADMIN")
                        .requestMatchers("/admin/cupones/**").hasRole("ADMIN")
